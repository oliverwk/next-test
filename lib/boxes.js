...
if (existsSync('/lib/config.json')) {
  ...
  //TODO: hier json import doen in for loop met process.env
} else {
  //Hier ben je dus in prod
  //TODO: hier betsaat hij niet dus dan checken of process.env.privateKey bestaat
}*/

export let boxMakeToken = async () => {
    let key = {
      key: process.env.dev ? Buffer.from(process.env.privateKey, 'base64') : process.env.privateKey,
